...
Furthermore we will be adding a new tool called curve where the basis is the line tool, but it will be able to be curved. Also we will change the appearance of the application to make it more personalised.