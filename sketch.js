...
function draw() {
    ...
    if(mouseX >= 0 && mouseY <= height && mouseY > 0){
        ...
        {
            document.body.style.cursor = "url('assets/freehandCurzor.png'), auto";
        }
        else if(toolbox.selectedTool.name == "sprayCanTool")
        {
            document.body.style.cursor = "url('assets/sprayCanCurzor.png'), auto";
        }
        else if(toolbox.selectedTool.name == "rubber")
        {
            document.body.style.cursor = "url('assets/rubberCurzor.png'), auto";
        }
        else 
        {
